...
//For the draft, ask the user to input a series of integers, printing each one. 
//Terminate when the user enters any non-integer. 
//Do not let your code throw an exception (terminate with an error)

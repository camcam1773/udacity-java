...
public class CountryNames
{
    ...
    public String getCompleteName(String name)
    {
        ...
        if ("BelizeCambodgeMexiqueMozambiqueZaireZimbabwe".contains(name)) {
            return "le "+name;
        }
        else if ("Etats-UnisPays-Bas".contains(name)) return "les "+name;
        
        else if ("AEIOU".contains(first)) return "l'"+name;
         
        else if (last.contains("e")) return "la "+name;
         
        else if ("aiou".contains(last)) return "le "+name;
